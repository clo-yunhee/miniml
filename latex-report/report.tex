...
string               & -                                                 & value: String                                       \\ \hline
nativefun1           & \multirow{3}{4cm}{params: List[Type], to: Type} & fun: Value -> Value                      \\ \cline{1-1} \cline{3-3} 
nativefun2           &                                                   & fun: Value -> Value -> Value  \\ \cline{1-1} \cline{3-3} 
fun                  &                                                   & env: Environment, params: List[Name], body: AST \\ \hline
...
L'évaluation s'effectue récursivement
